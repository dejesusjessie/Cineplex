<?php
/*
 * The first page for guests to visit our webpage
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="nav justify-content-right">
                                <li class="nav-item" style="font-size: 25px !important;">
                                        <a class="nav-link active" href="./movie_home.php#">Home</a>
                                </li>
                                <li class="nav-item" style="font-size: 25px !important;">
                                ...
                                <li class="nav-item" style="font-size: 25px !important;">
                                        <a class="nav-link" href="../customer_page/customer_index.php">Login</a>
                                </li>
                        </ul>
                </div>
                </nav>
                        ...
                        <div class="row">
                                ...
                                ?>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                                <div class="btn-group">
                                                <button type="button" class="btn btn-sm btn-outline-secondary" onclick="myFunction()">Get Ticket</button>
                                                </div>
